                        ...
                        <ul class="list-group">
                            <?php foreach ($d->g->materias as $m): ?>
                                <li class="list-group-item">
                                    ...
                                    <div class="btn-group float-right">
                                        <a class="btn btn-success btn-sm" href="<?php echo buildURL('alumno/lecciones', ['id_materia' => $m->id_materia, 'id_profesor' => $m->id_profesor], false, false); ?>"><i class="fas fa-play-circle"></i> Lecciones</a>                                        
                                        <a class="btn btn-warning btn-sm" href="<?php echo buildURL('alumno/tareas', ['id_materia' => $m->id_materia, 'id_profesor' => $m->id_profesor], false, false); ?>"><i class="fas fa-layer-group"></i> Tareas</a>                                        
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
