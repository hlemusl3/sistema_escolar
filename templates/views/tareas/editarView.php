                ...
                <div class="card-body">
                        <form enctype="multipart/form-data" action="tareas/post_editar" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="fecha_inicial" name="fecha_inicial" value="<?php echo date('Y-m-d H:i:s', strtotime($d->t->fecha_inicial))?>" required>
                            </div>

                            <div class="form-group">
                                <div for="fecha_max">Fecha máxima</div>
                                <input type="datetime-local" class="form-control" id="fecha_max" name="fecha_max" value="<?php echo date('Y-m-d H:i:s', strtotime($d->t->fecha_disponible))?>" required>
                            </div>
