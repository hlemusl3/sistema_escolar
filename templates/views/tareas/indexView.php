                ...
                <?php if(!empty($d->tareas)): ?>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach($d->tareas as $l): ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo sprintf('tareas/ver_admin/%s', $l->id); ?>" >
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success btn-sm" href="<?php echo sprintf('tareas/ver_admin/%s', $l->id); ?>"><i class="fas fa-eye"></i></a>                                        
