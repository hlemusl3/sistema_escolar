    ...
    <div class="col-xl-6">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="agregar_foro">
                <div class="card-body">
                        <form action="foros/post_agregar" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="mensaje" id="mytextarea" cols="10" rows="5" class="form-control"></textarea>
                            </div>
                            ...
                            <button class="btn btn-success" type="submit">Guardar foro</button>
                        </form>
                </div>
            </div>
        </div>
