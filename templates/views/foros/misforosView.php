        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div div class="btn-group float-right">
                    <a class="btn btn-success btn-sm" href="foros/agregar"><i class="fas fa-plus"></i> <b>Agregar foro</b></a>
                </div>
                </h6>
            </div>
            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group float-right">
                                                            ...
                                                            <a class="btn btn-success btn-sm" href="<?php echo sprintf('foros/editar/%s', $l->id); ?>"><i class="fas fa-edit"></i></a>                                        
