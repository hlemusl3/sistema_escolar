            ...
            <div class="collapse show" id="grupo_data">
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $d->g->nombre; ?>" disabled>
                            </div>
                        ...
                        <ul class="list-group">
                            <?php foreach ($d->g->materias as $m): ?>
                                <li class="list-group-item">
                                    ...
                                    <div class="btn-group float-right">
                                        <a class="btn btn-success btn-sm" href="<?php echo buildURL('lecciones/agregar', ['id_materia' => $m->id_materia], false, false); ?>"><i class="fas fa-plus"></i> <b>Lección</b></a>
                                        <a class="btn btn-success btn-sm" href="<?php echo sprintf('grupos/materia/%s', $m->id_materia); ?>"><i class="fas fa-eye"></i></a>                                        
                                    </div>
                                    <br>
                                    <br>
                                    <div class="btn-group float-right">
                                        <a class="btn btn-warning btn-sm" href="<?php echo buildURL('tareas/agregar', ['id_materia' => $m->id_materia], false, false); ?>"><i class="fas fa-plus"></i> <b> Tareas</b></a>
                                        <a class="btn btn-warning btn-sm" href="<?php echo sprintf('grupos/materia/%s', $m->id_materia); ?>"><i class="fas fa-eye"></i></a>                                        
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
