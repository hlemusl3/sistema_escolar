...
function get_materias_disponibles_grupo() {
  ...
  $.ajax({
    ...
    toastr.error('Hubo un error con la petición.', '¡Upss!');
  }).always(function() {
    wrapper.waitMe('hide');
  })
}
...
//Función para cargar los alumnos de grupo
...
function remover_suspension_alumno(e) {
  ...
  //Dibujar gráfica de resumen de enseñanza
